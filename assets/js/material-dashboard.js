...
if (document.querySelector('.fixed-plugin')) {
  ...
  var fixedPluginButtonNav2 = document.querySelector('.profileImage');
  ...
  if (fixedPluginButtonNav || fixedPluginButtonNav2) {
    ...
    fixedPluginButtonNav2.onclick = function() {
      if (!fixedPlugin.classList.contains('show')) {
        fixedPlugin.classList.add('show');
      } else {
        fixedPlugin.classList.remove('show');
  ...
  document.querySelector('body').onclick = function(e) {
    if (e.target != fixedPluginButton && e.target != fixedPluginButtonNav && e.target != fixedPluginButtonNav2 && e.target.closest('.fixed-plugin .card') != fixedPluginCard) {
      fixedPlugin.classList.remove('show');
    }
  }
